$(function() {
     $.get("https://v1.hitokoto.cn", null, function(a) {
        ...
        function() {
            ...
            b.src = "https://hm.baidu.com/hm.js?c7fa9b4e62f83653d8d7d694f80aadfd", a = document.getElementsByTagName("script")[0], a.parentNode.insertBefore(b, a)
    ...
    $(".comment").before('<div id="lv-container" data-id="city" data-uid="MTAyMC8zMjYyNC85MTg1"></div>').text("评论区加载中...").attr("disabled", !0), $("#lv-container").hide(),
        function(a, b) {
